...
public class Inpatient_Department extends DataPatient{
    public int patient = 0;
    public level Leveling;
    public Inpatient_Department(String birthday, String firstname, String lastname, String bloodType,String gender,String town,String history_drug_REAL, String idcard_REAL, String phonenumber_REAL) {
    ...
    public String toString() {
        return  "=====================================================================================\n" +
                "                       "+ Leveling.getLevel() + "           Inpetient Department " + getPatient() +"\n" +
