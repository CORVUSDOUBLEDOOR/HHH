...
public class Surgical_Department extends DataPatient{
    public int patient = 0;
    public level Leveling;
    public Surgical_Department(String birthday, String firstname, String lastname, String bloodType,String gender,String town,String history_drug_REAL, String idcard_REAL, String phonenumber_REAL) {
    ...
    public String toString() {
        return  "=====================================================================================\n" +
                "                 " + Leveling.getLevel() + "       Surgical Department " + getPatient() +"\n" +
