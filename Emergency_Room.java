...
public class Emergency_Room extends DataPatient{
    public int patient = 0;
    public level Leveling;
    public Emergency_Room(String birthday, String firstname, String lastname, String bloodType,String gender,String town,String history_drug_REAL, String idcard_REAL, String phonenumber_REAL) {
    ...
    public String toString() {
        return  "=====================================================================================\n" +
                "                         " + Leveling.getLevel() + "       Emergency Room " + getPatient() +"\n" +
